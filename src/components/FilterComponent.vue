...
<template>
    <div class="flex justify-center">
        <input type="text" v-model="search" @input="filterBySearch" placeholder="Buscar título..." class="border bg-[#090F21] border-[#64748B] rounded-md w-122 h-9 mx-2 mt-7 mb-7 p-4">
        <select v-model="filterYear" @change="filterByYear" class="border bg-[#090F21] border-[#64748B] rounded-md w-122 h-9 mx-2 mt-7 mb-7 ">
