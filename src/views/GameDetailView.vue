...
<template>
  ...
  <section class="px-50 py-5 flex">
      ...
      <div class="rounded-xl border-2 border-[#94a3b840] bg-[#0C1325] p-4 mt-10">
        <ul>
          <li class="flex justify-between my-2">
            ...
            <p class="items-center"><i class="fa-solid fa-star text-[#FACC15]"></i><strong>8.8</strong></p>
          </li>
          <li class="flex justify-between my-2">
          ...
          <li class="flex justify-between my-2">
            ...
            <p class="text-[#C084FC]"><strong>Filme</strong></p>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="ml-8">
      <h1 class="text-4xl">God of War II</h1>
      ...
      <div class=" rounded-xl border-2 border-[#94a3b840] bg-[#0C1325] p-4 mt-6">
        ...
        <p>Dando seguimento à história de Kratos, 'God of War II' melhora a jogabilidade e os gráficos, elevando a
          franquia a novos níveis. Com batalhas ainda mais intensas e uma narrativa envolvente, se tornou um sucesso
          entre os fãs.</p>
      </div>
      ...
      <div class=" rounded-xl border-2 border-[#94a3b840] bg-[#0C1325] p-4 mt-6 items-center">
        ...
        <ul class="flex">
          <li
            ...
            PlayStation 2</li>
          <li class="bg-[#94A3B850] px-3 py-2 mt-4 rounded-xl hover:bg-[#94A3B880] transition duration-300 ease-in-out">
            PlayStation 2</li>
        </ul>
      </div>

      <ul class="flex justify-between">
        <li class=" w-90 rounded-xl border-2 border-[#94a3b840] bg-[#0C1325] p-4 mt-6">
          <h2 class="text-[#94a3b8] mb-2">Desenvolvedora</h2>
          <p><strong>Santa Monica Studio</strong></p>
        </li>
        <li class=" w-90 rounded-xl border-2 border-[#94a3b840] bg-[#0C1325] p-4 mt-6">
          <h2 class="text-[#94a3b8] mb-2">Publicadora</h2>
          <p><strong>Sony Computer Entertainment</strong></p>
        </li>
      </ul>
