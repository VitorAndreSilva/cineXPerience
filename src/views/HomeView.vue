...
<template>
  <main class="">
    ...
    <div>
      ...
      <CarouselComponent 
      :movies="movieStore.filterByPopularity(25)"/>
    </div>
    <div>
      <div class="flex pt-10 pb-6 pl-32 text-2xl items-center">
    ...
    <div>
      ...
      <CarouselComponent 
      :movies="movieStore.filterByDecade(1990)"/>
    </div>
    <div>
      <div class="flex pt-10 pb-6 pl-32 text-2xl items-center">
      ...
      <CarouselComponent 
      :movies="movieStore.filterByDecade(2000)"/>
    </div>
    <div>
      <div class="flex pt-10 pb-6 pl-32 text-2xl items-center">
      ...
      <CarouselComponent 
      :movies="movieStore.filterByRating(7.5)"/>
    </div>
  </main>
</template>
<style scoped></style>
